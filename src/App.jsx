...
function App() {
  ...
  return (
    <>
      <main className="font-josefin-sans relative flex h-svh w-full flex-col bg-firstGradient md:flex-row">
        <Logo />
        <Image />
        <section className="md:bg-patternDesktop order-2 flex h-full w-full flex-col justify-center gap-10 bg-cover bg-center bg-no-repeat p-10 md:order-1 md:p-56">
          <h1 className="md:tracking-heading text-center text-5xl font-semibold uppercase tracking-widest text-red-gray md:text-left md:text-8xl">
            <span className="font-light text-red-desaturated">We&apos;re</span>{" "}
            coming soon
          </h1>
          <p className="text-pretty text-center text-sm font-semibold leading-6  tracking-wide text-red-desaturated md:w-4/5 md:text-left md:text-lg">
